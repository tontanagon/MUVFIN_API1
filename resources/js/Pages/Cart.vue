        ...
        <body class="bg-gray-100">
            <div class="container mx-auto">
                <div class="flex shadow-md">
                    <div
                        class="w-3/4 bg-white px-10 py-10 sm:px-4 md:px-4 lg:px-6 xl:px-8 2xl:px-8"
                    >
                        <div
                            class="flex justify-between border-b pb-8 columns-2"
                        >
                            <div class="flex items-center">
                                <h1
                                    class="font-bold text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl"
                                >
                                    Cart Movies
                                </h1>
                                <svg
                        ...
                        >
                            <div class="flex w-3/5 sm:w-2/5">
                                ...
                                >
                                    ...
                                    <span
                                        class="text-gray-500 text-xs leading-4"
                                    >
                                        {{ item.category }}<br />
                                        {{ item.length }} min
                                    </span>
                            ...
                            <div class="flex justify-center w-1/5">
                                ...
                                <!-- <input class="mx-2 border-full text-center w-12" type="text" v-model="item.quantity"
                                    readonly /> -->
                                <div
                                    class="mx-2 border-2 rounded-lg text-center w-12 px-2"
                                >
                                    {{ item.quantity }}
                                </div>
                    ...
                    >
                        <h1
                            class="font-bold text-lg sm:text-base pb-1 md:text-base lg:text-xl xl:text-xl 2xl:text-2xl border-b pb-8 mt-3"
                        >
                            Order Summary
                        </h1>
                        ...
                        <div class="border-t mt-8">
                            <span
                                class="font-light italic text-sm text-red-700 antialiased"
                                >10% discount for minimum purchase of 100
                                baht</span
                            >
                            <div
                                class="flex font-semibold justify-between py-0 mt-5 text-sm uppercase"
                            >
                                <span
                            ...
                            <div
                                class="flex font-semibold justify-between py-2 text-sm uppercase"
                            >
